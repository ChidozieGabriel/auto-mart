...
const { user, unRegisteredUser, invalidEmailUser } = new User();
...
describe('USER AUTHENTICATION ROUTES', () => {
  describe('POST /auth/signup', () => {
    ...
    it('should throw error when user signs up with already used email', (done) => {
      utils
        .post(`${route}/signup`, user)
        .then((res) => {
    ...
    it('should throw error when user signs up with an invalid email', (done) => {
      utils
        .post(`${route}/signup`, invalidEmailUser)
        .then((res) => {
          res.clientError.should.eql(true);
          res.body.should.be.an('object');
          res.body.should.have.property('error');
